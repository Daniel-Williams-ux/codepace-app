    ...
    <main className="bg-white text-slate-800">
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-slate-600 text-sm mt-8 max-w-2xl mx-auto">
            Move at your own pace. We won’t move forward until you’re confident
      ...
      <section className="bg-white py-16 px-6 max-w-6xl mx-auto text-center">
        ...
        <p className="mt-8 text-slate-600 text-sm max-w-xl mx-auto">
          Get full code reviews, deployment help, and a GitHub-ready portfolio.
        </p>
      </section>
      ...
      <section className="bg-blue-50 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-700 mb-6">
            Learn from engineers who’ve worked in AI — not just watched it from
            the sidelines. Real mentorship. Real experience. Real results.
          </p>
          <div className="bg-white shadow-md rounded-xl p-6 text-left flex flex-col md:flex-row items-center gap-6 max-w-2xl mx-auto">
            ...
            <div>
              <p className="text-slate-800 font-semibold">Your AI/ML Mentor</p>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-slate-700 mb-6">
          No pressure. No rushing. Just true understanding and confidence-first
          learning. Repeat as needed — we’ll never leave you behind.
        </p>
      ...
      <section className="py-20 px-6 bg-[#1D4ED8] text-white text-center">
        ...
        <p className="text-lg mb-6 max-w-2xl mx-auto">
          Build a future in machine learning — with real support, real projects,
          and zero pressure. This is how it should feel to learn.
        </p>
        <Link
          href="/pricing"
