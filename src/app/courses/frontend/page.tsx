...
export default function FrontendPage() {
  return (
    <>
      <Head>
        <title>Frontend Engineering | Studira</title>
        <meta
          name="description"
          content="Master the data analysis at your pace with personalized, one-on-one mentorship on Studira."
        />
        <link
          rel="canonical"
          href="https://studira.tech/courses/frontend"
        />
      </Head>
      <main className="bg-white text-slate-800">
        ...
        <section className="px-6 py-20 bg-gradient-to-b from-blue-50 to-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-700 mb-6">
              Learn HTML, CSS, JavaScript, React and more — taught by real
              humans. Go from zero to job-ready with confidence-based learning
        ...
        <section className="bg-gray-50 py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-slate-600 text-sm mt-8 max-w-2xl mx-auto">
              You’ll progress through each milestone at your own pace —
              mastering each skill set before moving on. No pressure, no
              deadlines — just real growth.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-16 px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-700 mb-10 max-w-2xl mx-auto">
              These are the kinds of real-world projects you’ll create during
              the bootcamp — apps that show your skills with HTML, CSS, JS,
              React, and APIs.
            </p>
            <div className="grid md:grid-cols-3 gap-6 text-left">
              {[
        ...
        <section className="bg-blue-50 py-16 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-700 mb-6">
              ...
              who’s built production-grade UIs — and knows how to guide
              beginners to real results.
            </p>
            <div className="bg-white shadow-md rounded-xl p-6 text-left flex flex-col md:flex-row items-center gap-6 max-w-2xl mx-auto">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  5+ years of professional UI/UX and React development.
                  Passionate about accessibility, clean CSS, and helping
                  learners gain real confidence.
                </p>
        ...
        <section className="py-16 px-6 max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-slate-700">
            <div>
              ...
              <p>
                Nope! We’ll teach you how to build well-structured, beautiful
                UIs even if you’ve never opened Figma. You’ll learn layout
                systems, spacing, color use, and best practices.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-2">
              ...
              <p>
                ...
                learn both logic (JavaScript, APIs) and structure (HTML/CSS) in
                a way that feels approachable and fun.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-2">
            ...
            <div>
              ...
              <p>
                Yes — if you show up, do the work, and ship strong projects,
                we’ll support you with portfolio prep, resume help, and mock
                interviews. Your work will speak for itself.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-[#1D4ED8] text-white text-center">
          ...
          <p className="text-lg mb-6">
            Don’t just watch tutorials — get real mentorship, build real
            projects, and land real opportunities.
          </p>
          <Link
            href="/pricing"
