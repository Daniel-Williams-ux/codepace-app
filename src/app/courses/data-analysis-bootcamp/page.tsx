...
export default function DataBootcampPage() {
  return (
    <>
      <Head>
        <title>Data Analysis | Studira</title>
        <meta
          name="description"
      ...
      <main className="bg-white text-slate-800">
        ...
        <section className="px-6 py-20 bg-gradient-to-b from-yellow-50 to-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-700 mb-6">
              Learn data cleaning, analysis, and visualization using Python,
              SQL, and modern tools — with expert mentorship and
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                >
                  <h4 className="font-bold mb-1 text-[#CA8A04]">
                    {item.stage}
                  </h4>
            ...
            <div className="bg-white shadow-md rounded-xl p-6 text-left flex flex-col md:flex-row items-center gap-6 max-w-2xl mx-auto">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  6+ years in analytics and BI roles. Loves making data simple
                  and impactful.
                </p>
        ...
        <section className="py-16 px-6 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-700 mb-6">
            Full-time job? Family responsibilities? No problem. This course
            adapts to your pace — with support when you need it.
          </p>
