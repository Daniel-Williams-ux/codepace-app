...
export default function BackendPage() {
  return (
    <>
      <Head>
        <title>Backend Engineering | Studira</title>
        <meta
          name="description"
          content="Master backend at your pace with personalized, one-on-one mentorship on Studira."
        />
      ...
      <main className="bg-white text-slate-800">
        ...
        <section className="px-6 py-20 bg-gradient-to-b from-blue-50 to-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-700 mb-6">
              Learn Node.js, APIs, databases, authentication, and more — taught
              by real humans. Go from beginner to backend job-ready with
        ...
        <section className="bg-gray-50 py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-slate-600 text-sm mt-8 max-w-2xl mx-auto">
              You’ll master each milestone at your own pace — with no pressure
              and no deadlines. Just confident, lasting skill-building.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-16 px-6 max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-700 mb-10 max-w-2xl mx-auto">
            ...
            real-world APIs, databases, and backend systems built with
            production tools.
          </p>
          ...
          <p className="mt-8 text-slate-600 text-sm max-w-xl mx-auto">
            ...
            help. You will graduate with a GitHub portfolio and real-world
            backend skills.
          </p>
        </section>
        ...
        <section className="bg-blue-50 py-16 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-700 mb-6">
              ...
              engineer who’s been where you are and knows how to help you grow.
              We don’t just teach backend — we coach, support, and cheer you on.
            </p>
        ...
        <section className="py-16 px-6 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-700 mb-6">
            Whether you’re working full-time, raising kids, or learning
            part-time, our backend program adapts to your life. You set the
            pace.
          </p>
        ...
        <section className="bg-blue-50 py-16 px-6 max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-slate-700">
            ...
            <div>
              ...
              <p>
                Not harder — just different. Backend focuses more on data,
                logic, and reliability. We teach it step by step, with real
            ...
            <div>
              ...
              <p>
                We’ll teach you just enough infrastructure to be dangerous.
                You’ll deploy real projects with Docker and cloud tools — no
                deep AWS experience needed.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-2">
